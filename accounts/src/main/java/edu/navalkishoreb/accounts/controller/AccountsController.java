...
import edu.navalkishoreb.accounts.dto.AccountContactInfoDto;
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to get Accounts Service java information"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "REST API to get Accounts Service Contact information"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
